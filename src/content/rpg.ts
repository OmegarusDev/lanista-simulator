...
> = {
  ...
  ARMAMENTARIUM: {
    ...
    cost: 100,
    virtusReq: 8,
    blurb: 'Armory: swap kit pieces + upgrade grades.',
  },
  BARRACKS: {
    id: 'BARRACKS',
    name: 'Barracks',
...
> = {
  PRESS: {
    id: 'PRESS',
    name: 'Press',
    blurb: 'Close and punish — lean-in reads on the sand.',
    pursueBiasAdd: 0.16,
    clinchPanicAdd: -0.08,
  },
  YIELD: {
    id: 'YIELD',
    name: 'Yield',
    blurb: 'Give ground, catch them long — open measure stance.',
    pursueBiasAdd: -0.14,
    clinchPanicAdd: 0.12,
  },
  ANGLE: {
    id: 'ANGLE',
    name: 'Angle',
    blurb: 'Circle for the cut — lateral bias is visible.',
    pursueBiasAdd: 0,
    clinchPanicAdd: 0.02,
  },
};
